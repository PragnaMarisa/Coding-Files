...
String[] strTableColumns = new String[tableColumns.length()];

for (int counter = 0; counter < tableColumns.length(); counter++) {
    strTableColumns[counter] = tableColumns.getString(counter);
}

session.setAttribute(tableName, strTableColumns);
